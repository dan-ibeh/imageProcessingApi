...
const inputDir =
  'C:/Users/Daniel Ibeh/OneDrive/Documents/Projects/Udacity Full Stack JavaScript Nanodegree/imageProcessingApiDirs/input/';
const outputDir =
  'C:/Users/Daniel Ibeh/OneDrive/Documents/Projects/Udacity Full Stack JavaScript Nanodegree/imageProcessingApiDirs/output/';
...
routes.get('/', async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    if (fs.existsSync(outputDir + `${filename}_thumb.jpg`)) {
      ...
      convert(res, filename, height, width);
    }
  } catch (err) {
    console.error(err);
  }
